...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/IA_PlayerActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @IA_PlayerActions: IInputActionCollection2, IDisposable
{
    ...
    ~@IA_PlayerActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, IA_PlayerActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, IA_PlayerActions.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@IA_PlayerActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
